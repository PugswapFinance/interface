...
const FILLED = {
  ...
  pink: 'bg-gradient-to-r from-pink to-opaque-blue w-full rounded text-high-emphesis opacity-80 hover:opacity-100 disabled:bg-opacity-80',
  ...
  gradient:
    'w-full text-high-emphesis bg-gradient-to-r from-purple to-opaque-blue opacity-80 hover:opacity-100 disabled:bg-opacity-80',
}
