...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.MOONRIVER]: [...WRAPPED_NATIVE_ONLY[ChainId.MOONRIVER], MOONRIVER.DAI, MOONRIVER.USDC, MOONRIVER.SILVER, MOONRIVER.BUSD],
  [ChainId.MATIC_TESTNET]: [...WRAPPED_NATIVE_ONLY[ChainId.MATIC_TESTNET], MATIC_TESTNET.USDC, MATIC_TESTNET.SILVER],
  [ChainId.CRONOS_TESTNET]: [...WRAPPED_NATIVE_ONLY[ChainId.CRONOS_TESTNET], CRONOS_TESTNET.USDC, CRONOS_TESTNET.SILVER],
}
...
export const INIT_CODE_HASH: string = '0x8c1a5dd4c9f79bec877d2014ab9e5c8f7aa27d6d521093dd19b9fb549a6a35c1' // Changed this
