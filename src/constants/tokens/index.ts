...
export const MOONRIVER: { [key: string]: Token } = {
  ...
  SILVER: new Token(ChainId.MOONRIVER, '0x6bD193Ee6D2104F14F94E2cA6efefae561A4334B', 18, 'SILVER', 'Solarbeam Token'),
...
export const MATIC_TESTNET: { [key: string]: Token } = {
  ...
  SILVER: new Token(ChainId.MATIC_TESTNET, '0x8Dd5d27874D877666193251756334b9291ED114F', 18, 'VAR', 'Silver Token'),
}

export const CRONOS_TESTNET: { [key: string]: Token } = {
  USDC: new Token(ChainId.CRONOS_TESTNET, '0x76D3Ae5Ef3Edc8F7d946d7E47be3DC22bE4D5754', 18, 'USDC', 'USD Test Coin'),
  SILVER: new Token(ChainId.CRONOS_TESTNET, '0x810DC08096E28C1306818A71a196F4E17d8D9cB4', 18, 'SILVER', 'Silver Token'),
}
...
export const SILVER: ChainTokenMap = {
  [ChainId.MOONRIVER]: new Token(ChainId.MOONRIVER, SOLAR_ADDRESS[ChainId.MOONRIVER], 18, 'SILVER', 'Solarbeam Token'),
  [ChainId.MATIC_TESTNET]: new Token(ChainId.MATIC_TESTNET, SOLAR_ADDRESS[ChainId.MATIC_TESTNET], 18, 'SILVER', 'Solarbeam Token'), // Changed this
  [ChainId.CRONOS_TESTNET]: new Token(ChainId.CRONOS_TESTNET, SOLAR_ADDRESS[ChainId.CRONOS_TESTNET], 18, 'SILVER', 'Silver Token'), // Changed this
}
